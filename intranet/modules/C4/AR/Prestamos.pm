...
sub getAllPrestamosVencidosParaMail{
		...
		if(scalar(@$prestamos_vencidos_temp_array_ref) > 0){
				...
				eval{
						...
						foreach my $prestamo (@$prestamos_vencidos_temp_array_ref){

								# Si el prestamo existe, se agrega a la cola para enviar el correo
								if(existePrestamo($prestamo->{'id_prestamo'})){
