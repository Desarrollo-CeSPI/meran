...
( 'biblioitems', 'seriestitle', 'Ti­tulo', '490', 'a'),
...
( 'biblioitems', 'volume', 'Number of part/section of a work', '490', 'v'),
( 'biblioitems', 'volumeddesc', 'Ti­tulo', '490', 'a'),
...
(116, '700', 'a', 'LIB', 'Autor secundario/Colaboradores', 'auto', 1, 1, 0, 12, 1, 1, 283, '496705e6cd65f25e4e41ef8f26d0027e', 0, 1, ' digits:true ', 10),
...
(228, '700', 'e', 'LIB', 'Función', 'text', 1, 1, 0, 2, 1, 1, 284, '89a16936399743ab6537c00fd84de07a', 0, 1, ' alphanumeric_total:true ', 0),
...
(238, '700', 'e', 'DCA', 'Función', 'text', 1, 1, 0, 2, 1, 1, 287, '611244f681343b56cac4e9bc0341f63f', 0, 1, ' alphanumeric_total:true ', 0),
...
(251, '700', 'e', 'DCD', 'Función', 'text', 1, 1, 0, 3, 1, 1, 284, '2dbc9a57ba5d9b81e624585a90c0c423', 0, 1, ' alphanumeric_total:true ', 0),
...
(269, '700', 'e', 'TES', 'Función', 'text', 1, 1, 0, 2, 1, 1, 288, 'c9a8747e61ef069566a74ff08add9d89', 0, 1, ' alphanumeric_total:true ', 0),
...
(309, '700', 'e', 'FOT', 'Función', 'text', 1, 1, 0, 10, 1, 1, 284, '69e747d0fdb1d475236ce3fe25607671', 0, 1, ' alphanumeric_total:true ', 0),
...
(325, '260', 'b', 'LIB', 'Editor', 'text', 0, 2, 0, 19, 1, 1, 0, '632546631c044616b8b15c5eaef2c5cb', 0, 1, ' alphanumeric_total:true ', 0),
...
(354, '700', 'e', 'CDR', 'Función', 'text', 1, 1, 0, 2, 1, 1, 291, '5e647d19341462a3064d17c3b1a39782', 0, 1, ' alphanumeric_total:true ', 0),
...
(384, '700', 'e', 'ANA', 'Función', 'text', 1, 1, 0, 4, 1, 1, 285, '1cae00cebdc27054b19a081cfc8fbf57', 0, 1, ' alphanumeric_total:true ', 0),
...
(408, '700', 'e', 'ELE', 'Función', 'text', 1, 1, 0, 11, 1, 1, 284, 'c19657299c72a0d1e60c1a16663e5f23', 0, 1, ' alphanumeric_total:true ', 0),
...
(458, '700', 'e', 'SEM', 'Función', 'text', 1, 1, 0, 17, 1, 1, 289, '858a0c16d6b7dc1f1edc09a448b417aa', 0, 1, ' alphanumeric_total:true ', 0),
...
(495, '900', 'g', 'ALL', 'Carga', 'text', 0, 3, 0, 9, 1, 1, NULL, '5f4501dba83f2874220cc9b19cd00ef8', 0, 0, ' alphanumeric_total:true ', 0),
(496, '900', 'h', 'ALL', 'Modificación/Baja', 'text', 0, 3, 0, 10, 1, 1, NULL, 'b98dec6e4f42ed7a2b3ee327aeb64a38', 0, 0, ' alphanumeric_total:true ', 0),
(497, '900', 'i', 'ALL', 'Notas del catalogador', 'texta', 0, 3, 0, 11, 1, 1, NULL, '844feb9851dab2abf4a22217d1acd79a', 0, 0, ' alphanumeric_total:true ', 0),
(498, '900', 'j', 'ALL', 'Control de registro', 'text', 0, 3, 0, 12, 1, 1, NULL, 'c23b19ef18069b9f15a05e77e0ee2a1a', 0, 0, ' alphanumeric_total:true ', 0),
...
(507, '910', 'a', 'TES', 'Tipo de documento', 'combo', 1, 2, 1, 10, 1, 1, 275, '638d3dc0e0faf0294476d80e3af02077', 1, 1, ' digits:true ', 0),
(508, '995', 'c', 'ALL', 'Unidad de Información', 'combo', 1, 3, 1, 5, 1, 1, 276, '143935d9a7a13fa47006651f0a30c811', 0, 0, ' digits:true ', 0),
(509, '995', 'd', 'ALL', 'Unidad de Información de Origen', 'combo', 1, 3, 1, 6, 1, 1, 277, 'abae75e9d28b17a939d5987d3b32ea46', 0, 0, ' digits:true ', 0),
(510, '995', 'e', 'ALL', 'Estado', 'combo', 1, 3, 1, 7, 1, 1, 279, 'faa66bd9eed267e6fdd1e1d3a8058934', 0, 0, ' digits:true ', 0),
(511, '995', 'f', 'ALL', 'Código de Barras', 'text', 0, 3, 0, 8, 1, 1, NULL, 'b5dfe1fda14b1063f531a1ac6ba27bcc', 0, 0, ' alphanumeric_total:true ', 0),
(512, '995', 'm', 'ALL', 'Fecha de acceso', 'text', 0, 3, 0, 9, 1, 1, NULL, 'be58c5a2149fcbf70bdf9f5cca4ff7e4', 0, 0, ' alphanumeric_total:true ', 0),
(513, '995', 'o', 'ALL', 'Disponibilidad', 'combo', 1, 3, 1, 10, 1, 1, 278, 'df8af7bf6e82ca41d87359dfee68ce6b', 0, 0, ' digits:true ', 0),
(514, '995', 'p', 'ALL', 'Precio de compra', 'text', 0, 3, 0, 11, 1, 1, NULL, '993015834fea443da73123010db786d9', 0, 0, ' alphanumeric_total:true ', 0),
(515, '995', 't', 'ALL', 'Signatura Topográfica', 'text', 0, 3, 0, 12, 1, 1, NULL, 'c3cc7e32ba65d58db46d05cf769c8fcb', 0, 0, ' alphanumeric_total:true ', 0),
(516, '995', 'u', 'ALL', 'Notas del item', 'texta', 0, 3, 0, 13, 1, 1, NULL, 'ba3cc59c5b706d8d74dd997a03ff2c44', 0, 0, ' alphanumeric_total:true ', 0),
...
(28, 'cat_ref_tipo_nivel3', 'tipo_ejemplar', 'nombre', 'Tipo de Documento'),
...
(30, 'ref_colaborador', 'descripcion', 'descripcion', 1),
(31, 'ref_colaborador', 'codigo', 'codigo', 1),
(32, 'ref_colaborador', 'id', 'id', 1),
(33, 'cat_editorial', 'id', 'id', 1),
(34, 'cat_editorial', 'editorial', 'editorial', 1),
(35, 'ref_acm', 'codigo', 'Código CDU', 1),
(36, 'ref_signatura', 'signatura', 'Signatura topográfica', 1),
(37, 'ref_acm', 'id', 'id', 0),
(38, 'ref_signatura', 'id', 'id', 0);
...
(20, 'usr_estado', 'usr_regularidad', 'usr_estado_id', NULL);
...
(283, 116, 'autor', 'completo', 'completo', NULL),
(285, 384, 'colaborador', 'descripcion', 'descripcion', NULL),
(286, 238, 'colaborador', 'descripcion', 'descripcion', NULL),
(287, 238, 'colaborador', 'descripcion', 'descripcion', NULL),
(288, 269, 'colaborador', 'descripcion', 'descripcion', NULL),
(289, 458, 'colaborador', 'descripcion', 'descripcion', NULL),
(290, 354, 'colaborador', 'descripcion', 'descripcion', NULL),
(291, 354, 'colaborador', 'descripcion', 'descripcion', NULL);
