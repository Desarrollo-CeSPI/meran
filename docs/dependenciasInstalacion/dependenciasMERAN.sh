#/bin/bash
apt-get update -y
apt-get install apache2 apache2-mpm-prefork mysql-server libpdf-report-perl libhtml-template-expr-perl  libhtml-template-perl libnet-ldap-perl libdbd-mysql-perl libmail-sendmail-perl libmarc-record-perl libgd-gd2-perl libarchive-zip-perl libapache2-mod-perl2 libapache-db-perl libooolib-perl libpdf-report-perl  libchart-perl libtemplate-perl libnet-amazon-perl libnet-z3950-zoom-perl  aspell-es libtext-aspell-perl libnet-smtp-ssl-perl libspreadsheet-writeexcel-perl htmldoc libyaml-dev libcaptcha-recaptcha-perl libemail-mime-encodings-perl libproc-simple-perl libjson-perl libjson-xs-perl librose-db-perl librose-db-object-perl sphinxsearch libsphinx-search-perl libdigest-sha-perl libcrypt-cbc-perl libtext-levenshtein-perl  libnet-smtp-tls-perl libnet-ssleay-perl libnet-twitter-perl libwww-facebook-api-perl libspreadsheet-read-perl libyaml-perl libcgi-session-perl libdate-manip-perl liblocale-maketext-gettext-perl libspreadsheet-writeexcel-perl libfile-libmagic-perl libhttp-browserdetect-perl libtext-unaccent-perl libmarc-crosswalk-dublincore-perl libmarc-xml-perl libimage-size-perl  libdatetime-format-mysql-perl libfile-libmagic-perl libxml-checker-perl libdbix-xml-rdb-perl libdbi-perl libmoosex-types-perl libtest-compile-perl libwww-shorten-perl libhttp-oai-perl libxml-libxslt-perl libyaml-perl -y
